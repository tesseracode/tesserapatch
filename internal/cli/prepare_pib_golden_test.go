...
var acceptedCheckSourceProvenance = map[string]struct {
	...
	"internal/cli/prepare_routing_golden_test.go": {
		...
		CurrentSHA256: "854dafd27b7c58166df6c6ef93b4aa357a39a530da68e17265409e958f985eb6",
...
func preparePIBGoldenDelta(name, got string) error {
	...
	want, err = rgaS5ExpectedCaptureEventGolden(name, want)
	if err != nil {
		return err
	}
	want, err = rgaS5ExpectedVerifyGolden(name, want)
	if err != nil {
		return err
	}
