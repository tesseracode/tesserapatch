...
- [ADR-038: Bounded In-Memory Observation Image Retention](ADR-038-observation-image-retention.md) — Proposed, implemented for GH #15 S2 pending validation/review. A shared 32 MiB image budget, streaming Git bodies, and isolated recorder ownership retain exact preimages without unbounded body storage.
