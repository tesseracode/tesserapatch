...
- [ADR-042: Ordered Recipe No-op Proof](ADR-042-ordered-recipe-noop-proof.md) — Accepted (2026-09-09, GH #15 S5 independent rev-1 clarification/correction review). Initial-tree write permission is separate from ordered no-write witnesses; bounded prefix materialization does not cap streaming exact equality. Alias containment, gate-input dependencies and existing refusal/supersession semantics remain enforced. Runtime validation is pending.
