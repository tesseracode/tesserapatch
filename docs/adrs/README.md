...
- [ADR-037: Reconcile Operation-Replay Candidate Authority](ADR-037-reconcile-operation-replay-candidate-authority.md) — Accepted rev-6 baseline (2026-09-02); Proposed rev-7 capture-evidence amendment with [ADR-043](ADR-043-operation-candidate-capture-evidence.md) and the [companion PRD](../prds/PRD-reconcile-operation-replay-candidate.md), pending independent review. GH #15's v0.17.0 release prerequisite is satisfied. GH #13 implementation remains unassigned and gated on acceptance of the ADR-041 §7 follow-up; target v0.18.0 is unchanged.
...
- [ADR-041: Independent Capture-Event Consistency Evidence](ADR-041-independent-capture-event-evidence.md) — Accepted rev-1 (2026-09-09, GH #15 S5 independent contract review), implemented and shipped in v0.17.0. Deterministic companion evidence precedes final coverage publication; read-time pairing preserves capture authority across same-patch events. Includes bounded incomplete proofs, captured parent exclusions and 42 supplemental cases. The separate GH #13 follow-up in §7 is now Proposed as ADR-043/ADR-037/PRD rev-7; not yet accepted or implemented.
...
- [ADR-043: Operation-candidate Capture-evidence Identity Binding](ADR-043-operation-candidate-capture-evidence.md) — Proposed (2026-09-22), operator-selected canonical capture-event digest in candidate identity. Companion amendment to ADR-037/PRD rev-7 addressing ADR-041 §7; independent review pending, no runtime implementation authority.
