...
**Depends on**: [PRD-reconcile-hunk-overlap-detector](./PRD-reconcile-hunk-overlap-detector.md). Implementation requires `ADR-024-reconcile-evidence-and-revision-schema`.
