...
no-decision erratum (2026-08-27) and rev-18 removal-identity-re-probe
...
(**Accepted 2026-08-14**, rev-16; its companion rev-17 and rev-18 errata are
pending the same joint review as this document's). **This PRD and ADR-035 were
reviewed and accepted together.** ADR-035 locks the publication/history
decisions; this PRD states the product contract that depends on them. Where they
overlap, **ADR-035 is normative**.
