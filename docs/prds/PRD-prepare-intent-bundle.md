...
**Status**: Draft — Awaiting Review (rev-14)
**Date**: 2026-08-14
...
(**Proposed**, rev-14). **This PRD and ADR-035 must be reviewed together.**
...
- [ADR-035 intent bundle publication and history](../adrs/ADR-035-intent-bundle-publication-and-history.md) — **companion, Proposed rev-14**; the transaction, the archive and the honesty limits
...
as **Proposed rev-12**, keeps it in the ADR index, and requires it to be
...
2. **ADR-035 must be accepted.** It is `Proposed` at rev-14, and a writer cannot
