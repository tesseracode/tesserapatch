...
no-decision erratum (2026-08-28) — acceptance pending joint review**
**Date**: 2026-08-14
...
**proposed no-decision erratum**; AU implementation discovery corrected
**three** acceptance-matrix rows whose stated fixture expectations the
...
**one** acceptance-matrix row, `PIB-550`, and the §9.7.2 window row it tests.
...
**proposed no-decision erratum**; the independent S7 AX review found **three**
record inconsistencies between this document, the already-accepted rules and
the shipped product. **Exactly two acceptance-matrix rows are amended**:
...
(**Accepted 2026-08-14**, rev-16; its companion rev-17, rev-18 and rev-19
errata are pending the same joint review as this document's). **This PRD and
...
is **proposed**, with acceptance pending joint review — and it amends exactly
three stable rows: `PIB-542`, `PIB-543` and `PIB-544`. `PIB-542`'s first
...
is **proposed**, with acceptance pending joint review — and it amends exactly
one stable row: `PIB-550`. That row, and the fourth row of §9.7.2's window
...
**proposed**, with acceptance pending joint review — and it
