...
**Prepare intent-bundle PRD rev-8 + ADR-035 rev-8** 🚧 AWAITING REVIEW
...
plus preview/ledger drift. Rev-8 landed at `837f28a` with 530 PIB rows; joint
acceptance review is pending. No implementation is authorized.
